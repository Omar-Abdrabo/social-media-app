...
{
    public static array $extensions = ['jpg', 'jpeg', 'png', 'gif', 'webp', 'mp3', 'wav', 'mp4', "doc", "docx", "pdf", "csv", "xls", "xlsx", "zip"];
        ...
        return [
            ...
            'attachments' => [
                ...
                function ($attribute, $value, $fail) {
                    ...
                    if ($totalSize > 1 * 1024 * 1024 * 1024) {  // 1GB in bytes
    ...
    public function messages()
    {
        return [
            ...
            // 'attachments.*.max' => 'The maximum file size for attachments is 1GB.',
        ];
    }
}
